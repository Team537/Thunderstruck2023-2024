...
public class Robot {
    ...
    public ScoringPosition scoringPosition = ScoringPosition.MIDDLE;
    ...
    public void update() {
        ...
        opMode.telemetry.addData("feed forward",arm.feedForward);
        opMode.telemetry.addData("error",arm.error);
        opMode.telemetry.addData("derivative",arm.armPID.derivative);
        opMode.telemetry.addData("integral",arm.armPID.integral);
        opMode.telemetry.addData("out",arm.armPID.out);
